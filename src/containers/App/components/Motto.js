...
function Motto() {
  return (
    <div classNameName="ui vertical stripe segment">
      <h1 classNameName="ui center aligned horizontal header">
        Our Workshops & Events Empower You to
      </h1>
      <div classNameName="ui three column doubling stackable grid container">
        <div classNameName="column">
          <Design />
          <h2 classNameName="ui center aligned header motto massive label">
